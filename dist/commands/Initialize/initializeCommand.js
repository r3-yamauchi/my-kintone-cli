...
program
    ...
    const: answer = await, prompt([{ type:  = 'input', name:  = 'name', message:  = 'Project name', default:  = 'kintone-customization-project', when:  = !packageInfo['name'] }, { type:  = 'input', name:  = 'version', message:  = 'Version', default:  = '0.0.1', when:  = !packageInfo['version'] }, { type:  = 'input', name:  = 'description', message:  = 'Description', default:  = 'kintone customization project', when:  = !packageInfo['description'] }, { type:  = 'input', name:  = 'author', message:  = 'Author', default:  = '', when: packageInfo = ['author'] === undefined }, { type:  = 'input', name:  = 'license', message:  = 'License', default:  = 'MIT', when:  = !packageInfo['license'] }, { type:  = 'confirm', name:  = 'dependencies.@kintone/kintone-ui-component', message:  = 'Do you want to use @kintone/kintone-ui-component?', default:  = true, when: packageInfo = ['dependencies'] && packageInfo['dependencies']['@kintone/kintone-ui-component'] === undefined }, { type:  = 'confirm', name:  = 'dependencies.@kintone/rest-api-client', message:  = 'Do you want to use @kintone/rest-api-client?', default:  = true, when: packageInfo = ['dependencies'] && packageInfo['dependencies']['@kintone/rest-api-client'] === undefined }]) { },
